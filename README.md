...
- 实验过程性材料：
  ...
  - 实验答案的完整工程文件：[xv6-buddy_answer](<https://gitlab.eduxiji.net/T202410269994414/project2608132-274517/-/tree/main/xv6-buddy_answer>)
  - `xv6`原内存分配的输出验证性文件：[xv6-print-without-buddy](<https://gitlab.eduxiji.net/T202410269994414/project2608132-274517/-/tree/main/xv6-print-without-buddy>)
  - 添加伙伴分配器后内存分配的输出验证性文件：[xv6-print-with-buddy](<https://gitlab.eduxiji.net/T202410269994414/project2608132-274517/-/tree/main/xv6-print-with-buddy>)
